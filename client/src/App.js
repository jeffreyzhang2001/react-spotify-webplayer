        ...
        */}
        <main>
          {authorised ? (
            ...
            <div className="Container">
              <h2>Spotify Webplayer</h2>
              <p>
                This project is a simple web app that demonstrates how WebSockets can be used to interface with Spotify's API in real-time.

                <br /><br /> Built using Express, React, and Socket.io.
              </p>
